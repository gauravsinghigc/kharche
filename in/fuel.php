        ...
        <p class="data-display-2 bg-primary text-white p-2 mt-1">
          <span class="flex-s-b">
            ...
            <span class='w-25 text-right'>
              <span class='text-grey'>ODO Reading</span><br>
              <span><?php echo $Distance = FETCH("SELECT * FROM fillings where MONTH(FillingDate)='$ViewMonth' and YEAR(FillingDate)='$ViewYear' and MainVehicleId='" . $VehicleId . "' ORDER BY FillingId DESC limit 0, 1", "FillingOdoMeterReading");
              $GenerateMonth = "$ViewMonth-$ViewYear";?> Km </span>
            </span>
            <span class='w-25 text-right'>
              <span class='text-grey'>Km in <?php echo date("M", strtotime(IfRequested('GET', "viewingmonth", date('Y-m'), null))).", ".date("Y", strtotime(IfRequested('GET', "viewingmonth", date('Y-m'), null))); ?></span><br>
              <span>
                <?php
          ...
          <span class="flex-s-b mt-2">
            <span class='w-25 text-left'>
              ...
              <span>
                <?php
                $numDays = cal_days_in_month(CAL_GREGORIAN, $ViewMonth, $ViewYear);
                $Distance = AMOUNT("SELECT * FROM fillings where MONTH(FillingDate)='$ViewMonth' and YEAR(FillingDate)='$ViewYear' and MainVehicleId='" . $VehicleId . "'", "FilledDistanceKm");
          ...
          <div class="col-md-12 mb-1">
            <a href="edit-fuel.php?id=<?php echo SECURE($Filling->FillingId, "e"); ?>">
              <div class='flex-s-b filling-list'>
                <div class='w-100 p-1'>
                  <h6 class='mb-0 small'><small style='font-size:9px !important;'><i class='fa fa-gas-pump text-danger'></i> </small>
                  <span style='font-size:14px !important;'><?php echo $Filling->FillingOdoMeterReading - $PreviousDriveKm;?> 
                  <span style='font-size:9px !important;'><i class='fa fa-arrow-right text-secondary p-1'></i> </span>
                  <?php echo $Filling->FillingOdoMeterReading; ?> km </span>
                    <small class='text-gray fs-6 pull-right mt-1'>
                        <span class='p-1'><?php echo DATE_FORMATES("d M, Y", $Filling->FillingDate); ?> <?php echo DATE_FORMATES("h:i A", $Filling->FillingTime); ?>
                    </span>
                    </small>
                  </h6>
                  <p class='data-display-2 mb-0 mt-1'>
                    <span class="flex-s-b">
                         <span class='w-20 text-center bg-white pt-2 pb-2 text-center rounded-2'>
                        <span class='text-gray'>Km Driven</span><br>
                        <b class='bold text-success'>+<?php echo $NetKmDriven; ?> Km</b>
                      </span>
                      <span class='w-20 text-center bg-white pt-2 pb-2 text-center rounded-2'>
                        <span class='text-gray'>Fuel Consume</span><br>
                        <b class='text-info'><span style='font-size:7px !important;' class='text-secondary'><i class='fa fa-gas-pump'></i></span> <?php echo $PreviousFilledQty; ?> <?php echo $Filling->FilledFuelType; ?></b>
                      </span>
                      <span class='w-20 text-center bg-white pt-2 pb-2 text-center rounded-2'>
                        <span class='text-gray'>Mileage</span><br>
                        <b><?php echo $NetMileage; ?> km/<?php echo $Filling->FilledFuelType; ?></b>
                      </span>
                      <span class='w-20 text-center pt-2 pb-2'>
                        <span class='text-gray'>New Filling</span><br>
                        <b><?php echo $Filling->FillingQuantity; ?> <?php echo $Filling->FilledFuelType; ?></b>
                      </span>
                      <span class='w-20 text-center pt-2 pb-2'>
                        <span class='text-gray'>Fuel Cost</span><br>
                        <b><?php echo AuthAppUser("UserPriceType"); ?> <?php echo $Filling->FillingNetPrice; ?></b>
                      </span>
                    </span>
                    <span class='flex-s-b'>
                        <span class='w-20 text-center pt-1 pb-1'>
                        <span class='text-gray'>Fuel Price</span><br>
                      ...
                      <span class='w-20 text-center pt-1 pb-1'>
                       ...
                       <span class='w-20 text-center pt-1 pb-1'>
                        <span class='text-gray'>Fuel/1000</span><br>
                        <span><?php echo AuthAppUser("UserPriceType"); ?> <?php echo $CostForThousandsKm; ?></span>
                      </span>
                    </span>
                    <span class='flex-s-b'>
                        <span class='w-100 text-left pt-1 pb-1'>
